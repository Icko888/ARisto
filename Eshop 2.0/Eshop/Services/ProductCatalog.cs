    ...
    public static class ProductCatalog
    {
        public static List<Product> GetProduct()
        {
            return new List<Product>
            {
                ...
                new Product(41,"Orbit","Sweetmint", 40, 0),
                new Product(42,"Orbit","White",50,500),
                new Product(43,"Orbit","Orbit Apple",65,500),
                new Product(44,"Orbit","Eucalipto",65,500),
                new Product(45,"Orbit","Orbit Orange",65,500),
